...
interface VoiceAgentCardProps {
  ...
  index: number;
  isSelected: boolean;
  onClick: (agent: VoiceAgent) => void;
}

const VoiceAgentCard: React.FC<VoiceAgentCardProps> = ({ agent, index, isSelected, onClick }) => {
  ...
  return (
    ...
    >
      ...
      <p className="text-center text-sm mb-4" style={{ color: 'var(--text-secondary)' }}>Voice Assistant</p>
