...
const chatLogs: ChatLog[] = [
  {
    id: 1, customer: 'Emily Johnson', time: '15:42', date: '2024-01-15', duration: '8:12', status: 'Resolved',
    messagePreview: 'Hi, I need help with my subscription renewal…',
    satisfaction: 91, summary: 'Customer reported that her subscription appeared expired despite a recent payment. Agent confirmed the payment was processed, identified a sync delay in the billing system, and manually refreshed the subscription status. Issue resolved in one interaction.',
    tags: ['Billing', 'Subscription', 'Resolved'],
  },
  {
    id: 2, customer: 'Omar Farid', time: '14:20', date: '2024-01-15', duration: '5:30', status: 'Resolved',
    messagePreview: 'Can you help me reset my password? I keep getting errors…',
    satisfaction: 95, summary: 'Standard password reset request. Agent verified identity through security questions, sent reset link, and confirmed the customer could log in successfully with the new password.',
    tags: ['Password Reset', 'Quick Resolution'],
  },
  {
    id: 3, customer: 'Lisa Chen', time: '12:05', date: '2024-01-15', duration: '12:45', status: 'Escalated',
    messagePreview: 'I want to file a formal complaint about the service outage…',
    satisfaction: 35, summary: 'Customer was upset about a service outage that affected their business operations for several hours. Multiple attempts to resolve within chat were insufficient. Case was escalated to the senior escalation team with a priority flag.',
    tags: ['Complaint', 'Escalated', 'Service Outage'],
  },
  {
    id: 4, customer: 'James Wilson', time: '10:30', date: '2024-01-14', duration: '3:15', status: 'Pending',
    messagePreview: 'Is there a way to upgrade my plan mid-cycle?',
    satisfaction: 78, summary: 'Customer inquired about mid-cycle plan upgrade options. Agent explained the proration policy and presented available tiers. Customer is considering options and will follow up within 48 hours.',
    tags: ['Subscription', 'Upgrade', 'Pending Decision'],
  },
  {
    id: 5, customer: 'Aisha Bello', time: '09:10', date: '2024-01-14', duration: '6:00', status: 'Resolved',
    messagePreview: 'I was charged twice for last month. Can you investigate?',
    satisfaction: 88, summary: 'Duplicate charge identified and confirmed by the agent. A refund was initiated immediately and the customer was provided with a reference number. Expected refund timeline of 3-5 business days was communicated.',
