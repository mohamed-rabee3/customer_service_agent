...
const initialArchiveData: Supervisor[] = [
  { id: 1, name: 'Ahmed Mohamed', email: 'ahmed@example.com', type: 'Voice', status: 'Active', interventions: 145, performance: 92, avgTime: '4:32', failed: 8 },
  { id: 2, name: 'Sara Ahmed', email: 'sara@example.com', type: 'Chat', status: 'Active', interventions: 132, performance: 90, avgTime: '3:45', failed: 5 },
  { id: 3, name: 'Khaled Hassan', email: 'khaled@example.com', type: 'Voice', status: 'Active', interventions: 128, performance: 88, avgTime: '5:10', failed: 12 },
  { id: 4, name: 'Layla Mahmoud', email: 'layla@example.com', type: 'Chat', status: 'Inactive', interventions: 115, performance: 87, avgTime: '4:00', failed: 7 },
  { id: 5, name: 'Yousef Ibrahim', email: 'yousef@example.com', type: 'Voice', status: 'Active', interventions: 110, performance: 85, avgTime: '5:25', failed: 15 },
  { id: 6, name: 'Noor Al Emarat', email: 'noor@example.com', type: 'Voice', status: 'Active', interventions: 105, performance: 89, avgTime: '4:50', failed: 9 },
  { id: 7, name: 'Fatma Ali', email: 'fatma@example.com', type: 'Chat', status: 'Inactive', interventions: 98, performance: 91, avgTime: '3:30', failed: 4 },
  { id: 8, name: 'Mohamed Khaled', email: 'mohamedkh@example.com', type: 'Chat', status: 'Active', interventions: 92, performance: 86, avgTime: '4:15', failed: 10 },
];
...
const AdminArchive: React.FC = () => {
  const [archiveData, setArchiveData] = useState<Supervisor[]>(initialArchiveData);
  ...
  const getNextId = () => archiveData.length > 0 ? Math.max(...archiveData.map(s => s.id)) + 1 : 1;

  const handleAddSubmit = (data: { name: string; type: 'voice' | 'chat'; email: string }) => {
    const newSupervisor: Supervisor = {
      id: getNextId(), name: data.name, email: data.email,
