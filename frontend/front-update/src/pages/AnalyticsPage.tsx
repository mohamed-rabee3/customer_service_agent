...
const AnalyticsPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
            const isVoice = selectedType === 'voice';
            setMetrics({
                fcr: isVoice ? 68 : 74,
                totalCalls: isVoice ? 3427 : 5892,
                resolutionTime: isVoice ? "00:07:42" : "00:04:15",
                supervisorPerformance: isVoice ? 62 : 78,
                csat: isVoice ? 84 : 89,
            });
            ...
            setChartData(
                ["8am", "10am", "12pm", "2pm", "4pm", "6pm"].map((time) => ({
                    time,
                    interactions: (isVoice ? 60 : 80) + Math.floor(Math.random() * 100),
                }))
            );
            setIsLoading(false);
        }, 800);
