...
const mockNotifications = [
    { id: 1, agent: 'Agent-1', action: 'Access customer payment records', type: 'data-access' as const, icon: Database, severity: 'warning' as const, time: '2 min ago', status: 'pending' as const },
    { id: 2, agent: 'Agent-2', action: 'Delete all inactive user sessions', type: 'danger' as const, icon: AlertTriangle, severity: 'danger' as const, time: '5 min ago', status: 'pending' as const },
    { id: 3, agent: 'Agent-3', action: 'Export full conversation logs', type: 'data-access' as const, icon: Database, severity: 'warning' as const, time: '12 min ago', status: 'pending' as const },
    { id: 4, agent: 'Agent-1', action: 'Override escalation protocol', type: 'danger' as const, icon: Shield, severity: 'danger' as const, time: '20 min ago', status: 'pending' as const },
    { id: 5, agent: 'Agent-2', action: 'Access restricted knowledge base', type: 'data-access' as const, icon: Database, severity: 'warning' as const, time: '35 min ago', status: 'pending' as const },
];
...
const TopBar = ({ onToggleSidebar }: TopBarProps) => {
    ...
    const [statuses, setStatuses] = useState<Record<number, NotifStatus>>(
        Object.fromEntries(mockNotifications.map(n => [n.id, n.status]))
    );
