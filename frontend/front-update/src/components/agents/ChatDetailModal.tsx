...
const mockChatLines = [
  { speaker: 'Customer', text: 'Hi, I need help with my subscription.' },
  { speaker: 'Agent', text: 'Sure! Let me check your account.' },
  { speaker: 'Customer', text: 'I want to upgrade to the premium plan.' },
  { speaker: 'Agent', text: 'I can help with that. Let me pull up the options.' },
  { speaker: 'Customer', text: 'How much will it cost?' },
  { speaker: 'Agent', text: 'The premium plan is $29.99/month with all features included.' },
  { speaker: 'Customer', text: 'Sounds good, please proceed.' },
  { speaker: 'Agent', text: 'Done! Your plan has been upgraded successfully.' },
];
...
const ChatDetailModal: React.FC<ChatDetailModalProps> = ({ agent, onClose }) => {
  ...
  useEffect(() => {
    ...
    setFeedLines([mockChatLines[0]]);
    intervalRef.current = setInterval(() => {
      const i = idxRef.current;
      if (i < mockChatLines.length) {
        const line = mockChatLines[i];
